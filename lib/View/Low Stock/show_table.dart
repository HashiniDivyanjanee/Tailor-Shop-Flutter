...
class LowStockPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: LowProductPage(),
    );
  }
}

class LowProductPage extends StatefulWidget {
  @override
  _LowProductPageState createState() => _LowProductPageState();
}

class _LowProductPageState extends State<LowProductPage> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<LowProductViewModel>(context, listen: false).fetchProducts();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<LowProductViewModel>(
            ...
            children: [
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: TextField(
                    onChanged: (value) =>
                        Provider.of<LowProductViewModel>(context, listen: false)
                            .searchProduct(value),
